...
public interface ColouringScheme {
    ...
    /**
     * Colours a point which is in a Misiurewicz domain
     * @param period the period fo the Misiurewicz point that the point is in the domain of
     * @param preperiod the preperiod fo the Misiurewicz point that the point is in the domain of
     * @param iterations The number of iterations that the point needed to escape from the set
     * @return returns RGB colour as int
     */
